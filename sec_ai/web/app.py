...
def summarize_text_with_gpt4(text: str, api_key: str) -> str:
...
def summarize_text_with_gpt3_5(text: str, api_key: str) -> str:
...
def summarize_text_with_gpt3(text: str, api_key: str) -> str:
...
with left, st.expander("**SEC EDGAR** INPUT", expanded=True):
    llm_selector = st.selectbox("Select Large Language Model:",
    ["GPT-4", "GPT-3.5", "GPT-3"])
    ...
    if openai_api_key and text and st.button("Summarize"):
